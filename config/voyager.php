...
return [
    ...
    */
    ...
    'googlemaps' => [
         'key'    => env('GOOGLE_MAPS_KEY', 'AIzaSyAH4aTfEyjH6K8E7CO517zQNdMafvYxpUI'),
         'center' => [
             'lat' => env('GOOGLE_MAPS_DEFAULT_CENTER_LAT', '27.728656'),
             'lng' => env('GOOGLE_MAPS_DEFAULT_CENTER_LNG', '85.314722'),
         ],
