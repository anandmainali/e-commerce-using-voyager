        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    ...
                    <select id="product_category_id" name="product_category_id" class="form-control select2 select2-hidden-accessible">
    		    ...
    		    <select id="product_subcategory_id" name="product_subcategory_id" class="form-control select2 select2-hidden-accessible">
    ...
    <script type="text/javascript">
        $('#product_category_id').on('change',function(e){
            ...
            $.get('/json-subcategories?category_id='+category_id,function(data){
                ...
                $('#product_subcategory_id').append('<option value="0" disable="true" selected="true">Choose Subcategory</option>');
                $.each(data,function(index,Obj){
                    $('#product_subcategory_id').append('<option value="'+ Obj.id +'">'+ Obj.name +'</option>');
                });
            });
        });
    </script>
