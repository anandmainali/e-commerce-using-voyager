                    ...
                    <ul>
                        @foreach($products as $product)
                                ...
                                <tr>
                                    <td data-th="Product">
                                        <div class="row">
                                            <div class="col-sm-2 hidden-xs"><img src="{{productImage($product->image)}}" alt="..." class="img-responsive"/></div>

                                        </div>
                                    </td>
                                    <td data-th="Price"><h4>Product Name: {{$product->name}}</h4></td>
                                    <td data-th="Price"><h4>Price: Rs.{{$product->new_price}}</h4></td>
                                    <td data-th="Quantity">
