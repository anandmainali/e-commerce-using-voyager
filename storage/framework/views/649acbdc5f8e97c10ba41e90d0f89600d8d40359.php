                    ...
                    <ul>
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    <td data-th="Product">
                                        <div class="row">
                                            <div class="col-sm-2 hidden-xs"><img src="<?php echo e(productImage($product->image)); ?>" alt="..." class="img-responsive"/></div>

                                        </div>
                                    </td>
                                    <td data-th="Price"><h4>Product Name: <?php echo e($product->name); ?></h4></td>
                                    <td data-th="Price"><h4>Price: Rs.<?php echo e($product->new_price); ?></h4></td>
                                    <td data-th="Quantity">
                                        <h4>Quantity: <?php echo e($product->pivot->quantity); ?></h4>
                                    </td>
                                </tr>
                                <br>
