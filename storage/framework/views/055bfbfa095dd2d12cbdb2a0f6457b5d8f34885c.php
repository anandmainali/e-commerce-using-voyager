...
<body class="<?php echo $__env->yieldContent('class'); ?>">
    <div class="wrapper">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a href="<?php echo e(route('wishlist.index')); ?>">&emsp;<i class="fa fa-heart-o" aria-hidden="true"></i> My Wishlists <span class="label label-primary"> <?php echo e(count($wishlists)); ?></span></a><br>
