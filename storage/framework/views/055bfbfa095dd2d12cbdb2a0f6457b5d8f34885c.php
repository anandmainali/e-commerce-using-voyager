...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/bootstrap-dropdownhover.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/font-awesome.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/pe-icon-7-stroke.css')); ?>">
...
<body class="<?php echo $__env->yieldContent('class'); ?>" id="body">
    <div class="wrapper">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a href="<?php echo e(route('wishlist.index')); ?>"  id="wishlistcount">&emsp;<i class="fa fa-heart-o" aria-hidden="true"></i> My Wishlists <span class="label label-primary"> <?php echo e(count($wishlists)); ?></span></a><br>
          <a href="<?php echo e(route('wishlist.order')); ?>">&emsp;<i class="fa fa-shopping-cart" aria-hidden="true"></i> My Orders </a><br>
          <div class="dropdown-divider"></div>
           <a href="<?php echo e(route('setting')); ?>">&emsp;<i class="fa fa-cog" aria-hidden="true"></i> Setting</a><br>
          <a href="<?php echo e(route('logout')); ?>">&emsp;<i class="fa fa-sign-out" aria-hidden="true"></i> Logout</a>
        </div>
      </li> 
                                  
                        <?php else: ?>

                        <li><i class="fa fa-user" aria-hidden="true"></i> <a href="<?php echo e(route('register')); ?>">Register</a></li>
                        <li><i class="fa fa-sign-in" aria-hidden="true"></i><a href="<?php echo e(route('login')); ?>"> Sign In</a></li>
                        <?php endif; ?>
                ...
                <div class="container navbar-color">
                    <div class="row">
                        <div class="col-md-2 nav-left">
                            <!-- logo -->
                            <strong class="logo">
                                <a href="<?php echo e(route('/')); ?>"><img src="<?php echo e(productImage(setting('site.logo'))); ?>" height="100px" alt="logo"></a>
                            </strong><!-- logo -->
                        </div>
            ...
            <span>search</span>
                        ...
                        <div class="col-md-2 nav-right">
                            ...
                            <div class="block-minicart dropdown" id="nav-cart">
                                ...
                                <a class="minicart" href="<?php echo e(url('cart')); ?>">
                                    <span class="counter qty" >
                                        <span class="cart-icon"><i class="fa fa-shopping-bag" aria-hidden="true"></i></span>
                                        <span class="counter-number"><?php echo e(count(Cart::content())); ?></span>
                                    </span>
                                    <span class="counter-your-cart">
                                        <span class="counter-label">Your Cart:</span>
                                        <span class="counter-price" >Rs.<?php echo e(Cart::total()); ?></span>
                                    </span>
                                </a>
                                <div class="parent-megamenu" >
                                    <?php if(count(Cart::content()) > 0): ?>
                                        <div class="minicart-content-wrapper" >
                                            <div class="subtitle">
                                                You have <span><?php echo e(count(Cart::content())); ?></span> item(s) in your cart
                                            </div>
                                                    ...
                                                    <li class="product-inner">
                                                        <div class="product-thumb style1">
                                                            <div class="thumb-inner">
                                                                <a href="<?php echo e(route('shop.show',$product->model->slug)); ?>"><img src="<?php echo e(productImage($product->model->image)); ?>" alt="c1" style="height: 40px; width: 40px;"></a>
                                                            </div>
                                                        </div>
                                                        <div class="product-innfo">
                                                            <div class="product-name"><a href="<?php echo e(route('shop.show',$product->model->slug)); ?>"><small><?php echo e($product->name); ?></small></a></div>

                                                            <a href="<?php echo e(route('cart.index')); ?>" class="remove"><i class="fa fa-times" aria-hidden="true"></i></a> 
                                                            
                                                            <span class="price price-dark">
                                                                <ins>Rs.<?php echo e($product->price); ?></ins>
                                                            </span>
                                                        </div>
                                                    </li>
                                            ...
                                            <div class="subtotal">
                                                ...
                                                <span class="price">Rs.<?php echo e(Cart::total()); ?></span>
                                            </div>

                                            <div class="actions">
                                                                                         
                                                <div class="row">
                                                    <a class="btn btn-viewcart" href="<?php echo e(url('cart')); ?>">View cart</a>
                                                
                                                
                                                    <a class="btn btn-checkout" href="<?php echo e(route('checkout.index')); ?>">Checkout</a>
                                                </div>
